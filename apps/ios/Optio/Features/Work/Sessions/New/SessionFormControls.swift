...
// The pieces the session form is built from, all shaped like native Form
...
struct FormSectionHeader<Trailing: View>: View {
    ...
    var anchor: SessionFormAnchor? = nil
    @ViewBuilder var trailing: Trailing

    init(_ title: String, question: String? = nil, anchor: SessionFormAnchor? = nil, @ViewBuilder trailing: () -> Trailing = { EmptyView() }) {
        self.title = title
